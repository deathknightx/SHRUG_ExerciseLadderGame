...
//		{
//			if (!moving && i < waypoints.Length - 1 && Input.GetKeyDown("space")) {
//				print ("space");
//				i++;
//				moving = true;
//				iTween.MoveTo (this.gameObject, iTween.Hash (waypoints [i]));
//
//			} else {
//				moving = false;
//			}
//		}
        ...
        void Update()
        {
            //transform.LookAt(pathContainer.waypoints[currentPoint].transform);
